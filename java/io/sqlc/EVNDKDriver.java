...
public class EVNDKDriver {
  ...
  /** Interface to C language function: <br> <code> void sqlc_evmax_set_result_chunk_cutoff_size(int cutoff); </code>    */
  public static native void sqlc_evmax_set_result_chunk_cutoff_size(int cutoff);
