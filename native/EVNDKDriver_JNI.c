/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Tue Jan 27 16:39:28 EST 2026 ----! */
...
/*   Java->C glue code:
 *   Java package: io.sqlc.EVNDKDriver
 *    Java method: void sqlc_evmax_set_result_chunk_cutoff_size(int cutoff)
 *     C function: void sqlc_evmax_set_result_chunk_cutoff_size(int cutoff);
 */
JNIEXPORT void JNICALL
Java_io_sqlc_EVNDKDriver_sqlc_1evmax_1set_1result_1chunk_1cutoff_1size__I(JNIEnv *env, jclass _unused, jint cutoff) {
  sqlc_evmax_set_result_chunk_cutoff_size((int) cutoff);
}
